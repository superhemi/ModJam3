...
public class ItemDirk extends Item {
	
    private float weaponDamage;
    private final EnumToolMaterial toolMaterial;
	
	public ItemDirk(int par1, EnumToolMaterial par2EnumToolMaterial) {
		super(par1);
		this.toolMaterial = par2EnumToolMaterial;
        maxStackSize = 1;
		this.setMaxDamage(par2EnumToolMaterial.getMaxUses());
		this.setUnlocalizedName(Strings.RESOURCE_PREFIX + Strings.DIRK_NAME);
        this.setCreativeTab(BaseForgePC.tabsPC);
        this.weaponDamage = 3.5F + par2EnumToolMaterial.getDamageVsEntity();
